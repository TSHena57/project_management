...
<div class="row">
    <div class="col col-lg-9 mx-auto">
        ...
        <h6 class="mb-0 text-uppercase">Update Employee Information</h6>
        <hr/>
        <div class="card">
            <div class="card-body">
                <div class="border p-3 rounded">
                   <form class="row g-3" action="{{route('employee.update', $employee->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select single-select" id="designation_id" name="designation_id" required>
                                @foreach ($designations as $designation)
                                    <option value="{{$designation->id}}" @selected($designation->id == $employee->designation_id)>{{$designation->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="name">Full Name</label>
                            <input type="text" class="form-control" name="name" id="name" value="{{$employee->user->name}}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" name="email" id="email" value="{{$employee->user->email}}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="mobile" id="mobile" value="{{$employee->user->mobile}}">
                        </div>
                        <div class="col-md-6">
                            ...
                            <select class="form-select single-select" id="login_access" name="login_access" required>
                                <option value="0" @selected($employee->user->login_access == 0)>No Login</option>
                                <option value="1" @selected($employee->user->login_access == 1)>Can Login</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select single-select" id="is_active" name="is_active" required>
                                <option value="1" @selected($employee->is_active == 1)>Active</option>
                                <option value="0" @selected($employee->is_active == 0)>In Active</option>
                            </select>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">Address</label>
                            <textarea class="form-control" type="text" id="address" name="address">{{$employee->address}}</textarea>
                        </div>
                        <div class="col-md-12">
                            <div class="d-grid">
