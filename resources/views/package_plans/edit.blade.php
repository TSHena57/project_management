    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Package Plan</li>
            </ol>
        </nav>
    </div>
</div>
<div class="row">
    <div class="col col-lg-9 mx-auto">
        ...
        <h6 class="mb-0 text-uppercase">Update Package Plan Information</h6>
        <hr/>
        <div class="card">
            <div class="card-body">
                <div class="border p-3 rounded">
                   <form class="row g-3" action="{{route('package_plans.update', $plan->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select single-select" id="package_plan_type" name="package_plan_type" required>
                                <option value="Monthly" @selected($plan->package_plan_type == "Monthly")>Monthly</option>
                                <option value="Yearly" @selected($plan->package_plan_type == "Yearly")>Yearly</option>
                                <option value="Custom" @selected($plan->package_plan_type == "Custom")>Custom</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="price">Package Price <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" name="price" id="price" value="{{$plan->price}}" step="0.01">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select single-select" id="project_activity_log_available" name="project_activity_log_available" required>
                                <option value="1" @selected($plan->project_activity_log_available == 1)>Yes</option>
                                <option value="0" @selected($plan->project_activity_log_available == 0)>No</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select class="form-select single-select" id="gantt_chart_available" name="gantt_chart_available" required>
                                <option value="1" @selected($plan->gantt_chart_available == 1)>Yes</option>
                                <option value="0" @selected($plan->gantt_chart_available == 0)>No</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select class="form-select single-select" id="report_available" name="report_available" required>
                                <option value="1" @selected($plan->report_available == 1)>Yes</option>
                                <option value="0" @selected($plan->report_available == 0)>No</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select class="form-select single-select" id="client_login_available" name="client_login_available" required>
                                <option value="1" @selected($plan->client_login_available == 1)>Yes</option>
                                <option value="0" @selected($plan->client_login_available == 0)>No</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="max_employee_count">Max Employee / User <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" name="max_employee_count" id="max_employee_count" value="{{$plan->max_employee_count}}" step="0.01">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="max_project_count">Max Project <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" name="max_project_count" id="max_project_count" value="{{$plan->max_project_count}}" step="0.01">
                        </div>
                        <div class="col-md-12">
