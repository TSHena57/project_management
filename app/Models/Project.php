...
{
    protected $fillable = ['client_id','project_manager_id','project_name','open_date','close_date','project_value','description','project_current_status','awarded_by','created_by','updated_by'];
